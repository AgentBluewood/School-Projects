...
require_once('db_conn.php');
    ...
    if (isset($_SESSION['id']) && isset($_SESSION['user_name'])){
        if (isset($_POST['full_name']) && isset($_POST['address1']) && isset($_POST['address2']) && isset($_POST['city']) && isset($_POST['state']) && isset($_POST['zipcode'])) {
            ...
            //Validates all of user entered information and ensure specifications are met
            if (empty($fullName)) {
                ...
                //If all validations are passed, insert the client's information into the fuel database 
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php } ?>
                    <hr />
                    <p>Please fill out the following form to finish creating your account</p>
