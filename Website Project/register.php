...
if (isset($_POST['username']) && isset($_POST['password']) && isset($_POST['confirm_password'])) {
    ...
    $password_hash = password_hash($password, PASSWORD_BCRYPT); //encrpypt user password 

    //Validate all user entered information and ensure specifications are met
    if (strlen($password) < 6) {
        ...
        //Make sure username is not already taken before inserting account into database 
        ...
        //If username is free, insert usernmae and encrypted password into database
